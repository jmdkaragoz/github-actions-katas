...
SVC_NAME="actions.runner.jmdkaragoz-github-actions-katas.devopsacademy-instance72.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (jmdkaragoz-github-actions-katas.devopsacademy-instance72)"
